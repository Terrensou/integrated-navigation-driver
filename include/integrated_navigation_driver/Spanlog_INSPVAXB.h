// Generated by gencpp from file integrated_navigation_driver/Spanlog_INSPVAXB.msg
// DO NOT EDIT!


#ifndef INTEGRATED_NAVIGATION_DRIVER_MESSAGE_SPANLOG_INSPVAXB_H
#define INTEGRATED_NAVIGATION_DRIVER_MESSAGE_SPANLOG_INSPVAXB_H
...
#include <integrated_navigation_driver/Spanlog_BinaryHeader.h>
...
struct Spanlog_INSPVAXB_
{
  ...
  _header_type header;
   ...
   typedef  ::integrated_navigation_driver::Spanlog_BinaryHeader_<ContainerAllocator>  _log_header_type;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> const> ConstPtr;

}; // struct Spanlog_INSPVAXB_

typedef ::integrated_navigation_driver::Spanlog_INSPVAXB_<std::allocator<void> > Spanlog_INSPVAXB;

typedef boost::shared_ptr< ::integrated_navigation_driver::Spanlog_INSPVAXB > Spanlog_INSPVAXBPtr;
typedef boost::shared_ptr< ::integrated_navigation_driver::Spanlog_INSPVAXB const> Spanlog_INSPVAXBConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator1> & lhs, const ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> >
{
  ...
  static const char* value(const ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x68116dad8dd5445fULL;
  static const uint64_t static_value2 = 0x0fd1f54b974b91a6ULL;
};

template<class ContainerAllocator>
struct DataType< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> >
{
  static const char* value()
  {
    return "integrated_navigation_driver/Spanlog_INSPVAXB";
  }
...
template<class ContainerAllocator>
struct Definition< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> >
{
  static const char* value()
  {
...
"\n"
"================================================================================\n"
"MSG: integrated_navigation_driver/Spanlog_BinaryHeader\n"
"#INSPVAX header\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::integrated_navigation_driver::Spanlog_INSPVAXB_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "log_header: ";
    s << std::endl;
    Printer< ::integrated_navigation_driver::Spanlog_BinaryHeader_<ContainerAllocator> >::stream(s, indent + "  ", v.log_header);
    s << indent << "ins_status: ";
...
#endif // INTEGRATED_NAVIGATION_DRIVER_MESSAGE_SPANLOG_INSPVAXB_H
