// Generated by gencpp from file integrated_navigation_driver/Spanlog_INSPVAXA.msg
// DO NOT EDIT!


#ifndef INTEGRATED_NAVIGATION_DRIVER_MESSAGE_SPANLOG_INSPVAXA_H
#define INTEGRATED_NAVIGATION_DRIVER_MESSAGE_SPANLOG_INSPVAXA_H
...
#include <integrated_navigation_driver/Spanlog_ASCIIHeader.h>
...
struct Spanlog_INSPVAXA_
{
  ...
  _header_type header;
   ...
   typedef  ::integrated_navigation_driver::Spanlog_ASCIIHeader_<ContainerAllocator>  _log_header_type;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> const> ConstPtr;

}; // struct Spanlog_INSPVAXA_

typedef ::integrated_navigation_driver::Spanlog_INSPVAXA_<std::allocator<void> > Spanlog_INSPVAXA;

typedef boost::shared_ptr< ::integrated_navigation_driver::Spanlog_INSPVAXA > Spanlog_INSPVAXAPtr;
typedef boost::shared_ptr< ::integrated_navigation_driver::Spanlog_INSPVAXA const> Spanlog_INSPVAXAConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator1> & lhs, const ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> >
{
  static const char* value()
  {
    return "10c52aaa67032906f17cde498f7dd93f";
  }

  static const char* value(const ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x10c52aaa67032906ULL;
  static const uint64_t static_value2 = 0xf17cde498f7dd93fULL;
};

template<class ContainerAllocator>
struct DataType< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> >
{
  static const char* value()
  {
    return "integrated_navigation_driver/Spanlog_INSPVAXA";
  }
...
template<class ContainerAllocator>
struct Definition< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> >
{
  static const char* value()
  {
    return "std_msgs/Header header\n"
"\n"
"Spanlog_ASCIIHeader log_header\n"
"\n"
"# INS status\n"
...
"\n"
"================================================================================\n"
"MSG: integrated_navigation_driver/Spanlog_ASCIIHeader\n"
"#INSPVAX header\n"
"\n"
"string port\n"
"int32 sequence\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::integrated_navigation_driver::Spanlog_INSPVAXA_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "log_header: ";
    s << std::endl;
    Printer< ::integrated_navigation_driver::Spanlog_ASCIIHeader_<ContainerAllocator> >::stream(s, indent + "  ", v.log_header);
    s << indent << "ins_status: ";
...
#endif // INTEGRATED_NAVIGATION_DRIVER_MESSAGE_SPANLOG_INSPVAXA_H
