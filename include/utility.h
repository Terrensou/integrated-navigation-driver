...
#ifndef INTEGRATED_NAV_READER_GENERATENAVSATFIXMSG_H
#define INTEGRATED_NAV_READER_GENERATENAVSATFIXMSG_H

#endif //INTEGRATED_NAV_READER_GENERATENAVSATFIXMSG_H
