// Generated by gencpp from file integrated_navigation_reader/NMEA_GPCHC.msg
// DO NOT EDIT!


#ifndef INTEGRATED_NAVIGATION_READER_MESSAGE_NMEA_GPCHC_H
#define INTEGRATED_NAVIGATION_READER_MESSAGE_NMEA_GPCHC_H
...
struct NMEA_GPCHC_
{
  ...
  typedef boost::shared_ptr< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> const> ConstPtr;

}; // struct NMEA_GPCHC_

typedef ::integrated_navigation_reader::NMEA_GPCHC_<std::allocator<void> > NMEA_GPCHC;

typedef boost::shared_ptr< ::integrated_navigation_reader::NMEA_GPCHC > NMEA_GPCHCPtr;
typedef boost::shared_ptr< ::integrated_navigation_reader::NMEA_GPCHC const> NMEA_GPCHCConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator1> & lhs, const ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> >
{
  ...
  static const char* value(const ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x217290c45b44eecbULL;
  static const uint64_t static_value2 = 0x57899244d59da554ULL;
};

template<class ContainerAllocator>
struct DataType< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> >
{
  static const char* value()
  {
    return "integrated_navigation_reader/NMEA_GPCHC";
  }
...
template<class ContainerAllocator>
struct Definition< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::integrated_navigation_reader::NMEA_GPCHC_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // INTEGRATED_NAVIGATION_READER_MESSAGE_NMEA_GPCHC_H
