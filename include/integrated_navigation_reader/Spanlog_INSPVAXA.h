...
#include <integrated_navigation_reader/Spanlog_ASCIIHeader.h>
...
struct Spanlog_INSPVAXA_
{
  ...
  _header_type header;
   ...
   typedef  ::integrated_navigation_reader::Spanlog_ASCIIHeader_<ContainerAllocator>  _log_header_type;
...
"\n"
"================================================================================\n"
"MSG: integrated_navigation_reader/Spanlog_ASCIIHeader\n"
"#INSPVAX header\n"
"\n"
"string port\n"
"int32 sequence\n"
...
struct Printer< ::integrated_navigation_reader::Spanlog_INSPVAXA_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::integrated_navigation_reader::Spanlog_INSPVAXA_<ContainerAllocator>& v)
  {
    ...
    s << indent << "log_header: ";
    s << std::endl;
    Printer< ::integrated_navigation_reader::Spanlog_ASCIIHeader_<ContainerAllocator> >::stream(s, indent + "  ", v.log_header);
    s << indent << "ins_status: ";
