// Generated by gencpp from file integrated_navigation_reader/Spanlog_BinaryHeader.msg
// DO NOT EDIT!


#ifndef INTEGRATED_NAVIGATION_READER_MESSAGE_SPANLOG_BINARYHEADER_H
#define INTEGRATED_NAVIGATION_READER_MESSAGE_SPANLOG_BINARYHEADER_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> const> ConstPtr;

}; // struct Spanlog_BinaryHeader_

typedef ::integrated_navigation_reader::Spanlog_BinaryHeader_<std::allocator<void> > Spanlog_BinaryHeader;

typedef boost::shared_ptr< ::integrated_navigation_reader::Spanlog_BinaryHeader > Spanlog_BinaryHeaderPtr;
typedef boost::shared_ptr< ::integrated_navigation_reader::Spanlog_BinaryHeader const> Spanlog_BinaryHeaderConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator1> & lhs, const ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> >
{
  ...
  static const char* value(const ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xefc2497ed13aa18aULL;
  static const uint64_t static_value2 = 0x239ab76fa6d8e9f3ULL;
};

template<class ContainerAllocator>
struct DataType< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> >
{
  static const char* value()
  {
    return "integrated_navigation_reader/Spanlog_BinaryHeader";
  }
...
template<class ContainerAllocator>
struct Definition< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::integrated_navigation_reader::Spanlog_BinaryHeader_<ContainerAllocator>& v)
  {
...
#endif // INTEGRATED_NAVIGATION_READER_MESSAGE_SPANLOG_BINARYHEADER_H
