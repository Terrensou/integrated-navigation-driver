// Generated by gencpp from file integrated_navigation_reader/NMEA_GPGGA.msg
// DO NOT EDIT!


#ifndef INTEGRATED_NAVIGATION_READER_MESSAGE_NMEA_GPGGA_H
#define INTEGRATED_NAVIGATION_READER_MESSAGE_NMEA_GPGGA_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> const> ConstPtr;

}; // struct NMEA_GPGGA_

typedef ::integrated_navigation_reader::NMEA_GPGGA_<std::allocator<void> > NMEA_GPGGA;

typedef boost::shared_ptr< ::integrated_navigation_reader::NMEA_GPGGA > NMEA_GPGGAPtr;
typedef boost::shared_ptr< ::integrated_navigation_reader::NMEA_GPGGA const> NMEA_GPGGAConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator1> & lhs, const ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> >
{
  ...
  static const char* value(const ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2c46119af93e8816ULL;
  static const uint64_t static_value2 = 0xc7f5efaafeb91da0ULL;
};

template<class ContainerAllocator>
struct DataType< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> >
{
  static const char* value()
  {
    return "integrated_navigation_reader/NMEA_GPGGA";
  }
...
template<class ContainerAllocator>
struct Definition< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::integrated_navigation_reader::NMEA_GPGGA_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // INTEGRATED_NAVIGATION_READER_MESSAGE_NMEA_GPGGA_H
